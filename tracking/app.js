    ...
    _this.parseData = function() {
        ...
        $("#placeholder").bind("plotclick", function (event, pos, pitem) {
            if (pitem != null) {
                ...
                parametersHTML += '<tr><th>' + window.lang.speed + ':</th><td>' + item.speed + ' ' + window.distance_unit_hour + '</td></tr>';
...
function History() {
    ...
    _this.select = function(history_id) {
        ...
        if (item.status > 1 && typeof _this.markers[history_id] != 'undefined') {
            ...
            setTimeout(function () {
                app.map.fitBounds( _this.polyline_sector.getBounds(), app.getMapPadding() );
            }, 100);
        }
    };

    _this.filterData = function(tab) {
    ...
    _this.parse = function() {
        ...
        if (window.history_items != null) {
            ...
            setTimeout(function () { app.map.fitBounds( polylines.getBounds(), app.getMapPadding()); }, 200);
    ...
    _this.openPopup = function(e) {
        var id = e.target.id;
        var value = window.history_items[id];
        ...
        var html  = '';
        html += '<div class="popup-content" data-history-id="'+id+'">';
        html += '   <div class="popup-header">'+nav+'<div class="popup-title"></div></div>';
        html += '   <div class="popup-body">'+parametersHTML+'</div>';
        html += '</div>';
    ...
    _this.historyPointPopup = function (item) {
        var nav = '';
        nav += '<ul class="nav nav-tabs nav-default" role="tablist">';
        nav += '<li data-toggle="tooltip" data-placement="top" title="Close"><a href="javascript:" data-dismiss="popup"><i class="fa fa-times fa-1"></i></a></li>';
        nav += '</ul>';
...
function Sensors() {
    ...
    _this.inputs = function (parent) {
        ...
        if (type === 'ignition' || type === 'drive_business' || type === 'drive_private' || type === 'logical' || type === 'textual')
...
function Device(data) {
    ...
    _this.updateListItem = function(previous, current) {
        if ( ! listDom || ! document.contains(listDom[0]) ) {
            listDom = $('li[data-device-id="' + _this.id() + '"]', app.ajaxItems);
        }
    ...
    _this.updateWitgets = function () {
        ...
        app.widgets.attr('data-device-id', options.id);

        _this.containerDOMUpdate( app.widgets );

        app.widgets.find('[data-modal="services_create"]').attr('data-url', app.urls.devicesServiceCreate + options.id);
        app.widgets.find('[data-modal="sensors_create"]').attr('data-url', app.urls.devicesSonsorCreate + options.id);
    };
...
function EventSys(data) {
    ...
    _this.notice = function() {
        ...
        if (options.speed != null) {
            message += window.lang.speed + ': ' + options.speed + ' ' + window.distance_unit_hour + '<br>';
            notificationMessage += window.lang.speed + ': ' + options.speed + ' ' + window.distance_unit_hour + ', ';
        }
        ...
        new Notifications().notify(notificationTitle, notificationMessage, '/assets/images/marker-icon-2x.png', '/objects');
    };
    ...
    _this.popup = function() {
        ...
        parametersHTML += '<tr><th>' + window.lang.speed + ':</th><td>' + options.speed + ' ' + window.distance_unit_hour + '</td></tr>';
...
function MapTiles() {
    var
        ...
        1: {
            ...
            tile:       function(){
                var _tileLayer = L.gridLayer.googleMutant({
                    type: 'roadmap',
                    maxZoom: 21,
                    styles: app.settings.googleStyles
                });
        ...
        3: {
            ...
            traffic:    true,
            tile:       function(){
                var _tileLayer = L.gridLayer.googleMutant({type: 'hybrid', maxZoom: 21});
        ...
        4: {
            ...
            traffic:    true,
            tile:       function(){
                var _tileLayer = L.gridLayer.googleMutant({type: 'satellite', maxZoom: 21});
        ...
        5: {
            ...
            traffic:    true,
            tile:       function(){
                var _tileLayer = L.gridLayer.googleMutant({type: 'terrain', maxZoom: 21});
            ...
            switch (require) {
                case 'google':
                    ...
                    var len = $('script').filter(function () {
                        return ($(this).attr('src') == 'https://maps.google.com/maps/api/js?v=3&key=' + app.settings.keys.google);
                    }).length;
                    ...
                    if (len === 0) {
                        ...
                        scriptTag.type = 'text/javascript';
                        scriptTag.async = true;
                        scriptTag.src = 'https://maps.google.com/maps/api/js?v=3&key=' + app.settings.keys.google;
                        document.head.appendChild(scriptTag);
                    }
                    break;
                case 'yandex':
